const tos_template = `<h1>Website Terms and Conditions of Use</h1>

<h2>1. Terms</h2>

<p>By accessing this Website, accessible from [[ WEBSITE_URL ]], you are agreeing to be bound by these Website Terms and Conditions of Use and agree that you are responsible for the agreement with any applicable local laws. If you disagree with any of these terms, you are prohibited from accessing this site. The materials contained in this Website are protected by copyright and trade mark law.</p>
...
<p>Any claim related to [[ COMPANY_NAME ]]'s Website shall be governed by the laws of jm without regards to its conflict of law provisions.</p>`
...
function generate() {
    ...
    if (!company) {
        $('tosOutput').value = 'Please provide a company name.';
    } else if (!isValidHttpUrl(website)) {
        $('tosOutput').value = 'Please provide a valid website URL.';
    } else {
        $('tosOutput').value = tos_template.replaceAll('[[ COMPANY_NAME ]]', company).replaceAll('[[ WEBSITE_URL ]]', website);
    }
}
$('companyName').oninput = generate;
$('websiteUrl').oninput = generate;
generate();